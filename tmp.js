...
//CANVAS Para una región dibujable con atributo de altura y ancho para gráficos 2d
var WIDTH = 800;
var HEIGHT = 850;

var COLORS = { white: "rgb(254, 250, 236)", black: "rgb(7, 5, 14)", blue: "rgb(36, 32, 95)", red: "rgb(129, 43, 56)" };

//1 Arreglo general para que forme el tablero general y 9 subtableros
var boards = [
...
// Arreglo para cuando gana en los subtableros
...
// Comprobación 1 o -1 si un jugador específico ha ganado, devuelve 0 si nadie ha ganado.
...
//Funcion que hace que la IA elija un tablero para jugar cuando puede jugar en cualquier lugar
...
function game() {
    ...
    if (currentTurn === -1 && gameRunning && AIACTIVE) {
        ...
        //CALCULA LA CANTIDAD RESTANTE DE CUADROS VACIOS
        var count = 0;
        ...
        if (bestMove !== -1) { //Esta condición solo debería ser falsa si el tablero está lleno, pero está aquí por si acaso
            ...
            //Elige jugar en el cuadrado con la evaluación más alta en la mejor matriz de puntuación
